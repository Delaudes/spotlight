...
describe('GameService', () => {
    ...
    it('should update grid', () => {
        ...
        expect(view.viewModel.get().grid).toEqual({
            cells: [
                [{ x: 0, y: 0, lightLevel: 0 }, { x: 0, y: 1, lightLevel: 0 }, { x: 0, y: 2, lightLevel: 0 }, { x: 0, y: 3, lightLevel: 0 }, { x: 0, y: 4, lightLevel: 0 }],
                [{ x: 1, y: 0, lightLevel: 0 }, { x: 1, y: 1, lightLevel: 0 }, { x: 1, y: 2, lightLevel: 0 }, { x: 1, y: 3, lightLevel: 0 }, { x: 1, y: 4, lightLevel: 0 }],
                [{ x: 2, y: 0, lightLevel: 0 }, { x: 2, y: 1, lightLevel: 0 }, { x: 2, y: 2, lightLevel: 0 }, { x: 2, y: 3, lightLevel: 0 }, { x: 2, y: 4, lightLevel: 0 }],
                [{ x: 3, y: 0, lightLevel: 0 }, { x: 3, y: 1, lightLevel: 0 }, { x: 3, y: 2, lightLevel: 0 }, { x: 3, y: 3, lightLevel: 0 }, { x: 3, y: 4, lightLevel: 0 }],
                [{ x: 4, y: 0, lightLevel: 0 }, { x: 4, y: 1, lightLevel: 0 }, { x: 4, y: 2, lightLevel: 0 }, { x: 4, y: 3, lightLevel: 0 }, { x: 4, y: 4, lightLevel: 0 }]
            ],
            spotlight: false,
            size: 5,
            sizeOptions: [3, 4, 5, 6, 7],
    ...
    describe('play', () => {
        ...
        it('should reset cell light level correctly : exotic', () => {
            service.play(new GridDomainModel([
